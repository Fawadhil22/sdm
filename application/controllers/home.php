...
class Home extends CI_Controller {
  ...
  {
      $this->data['cats'] = $this->modelcrud->get_kecamatan();
      return $this->load->view('tambah_data',$this->data);
    // $data['provinsi']=$this->modelcrud->get_all_provinsi();
    // $this->load->view('tambah_data',$data);

  }
  function add_ajax_kab($id_prov){
        $query = $this->db->get_where('kabkota',array('id'=>$id_prov));
    ...
    function add_ajax_kec($id_kab){
        $query = $this->db->get_where('kecamatan',array('id'=>$id_kab));
